...
public class Task1_StaleElementsRefex {
    public static void main(String[] args) throws InterruptedException {
       ...
       // 1. Open Chrome browser
        ...
        // //*[@onclick='addElement()'] or  //button[@onclick='addElement()']
        WebElement clickAddElementBtn = driver.findElement(By.xpath("//button[.='Add Element']"));
